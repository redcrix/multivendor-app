...
export class CheckoutAddressPage implements OnInit {
  ...
  async getCheckoutForm() {
    ...
    await this.api.postItem("get_checkout_form", data).subscribe(
      (res) => {
  ...
  getCountries() {
    this.api
      .getItem("settings/general/woocommerce_specific_allowed_countries")
      .subscribe(
        (res) => {
          this.countries = res;
        },
  ...
  async updateOrderReview() {
    await this.api.postItem("update_order_review").subscribe(
      (res) => {
  ...
  validateForm() {
    if (
      ...
      this.checkoutData.form.billing_first_name == undefined
    ) {
    ...
    if (
      ...
      this.checkoutData.form.billing_last_name == undefined
    ) {
    ...
    if (
      this.checkoutData.form.billing_phone == "" ||
      this.checkoutData.form.billing_phone == undefined
    ) {
    ...
    if (
      ...
      this.checkoutData.form.billing_address_1 == undefined
    ) {
    ...
    if (
      ...
      this.checkoutData.form.billing_city == undefined
    ) {
    ...
    if (
      ...
      this.checkoutData.form.billing_postcode == undefined
    ) {
    ...
    if (
      ...
      this.checkoutData.form.billing_country == undefined
    ) {
    ...
    if (
      this.checkoutData.form.billing_state == "" ||
      this.checkoutData.form.billing_state == undefined
    ) {
    ...
    if (this.checkoutData.form.ship_to_different_address) {
      if (
        ...
        this.checkoutData.form.shipping_first_name == undefined
      ) {
      ...
      if (
        ...
        this.checkoutData.form.shipping_last_name == undefined
      ) {
      ...
      if (
        ...
        this.checkoutData.form.shipping_address_1 == undefined
      ) {
      ...
      if (
        ...
        this.checkoutData.form.shipping_city == undefined
      ) {
      ...
      if (
        this.checkoutData.form.shipping_postcode == "" ||
        this.checkoutData.form.shipping_postcode == undefined
      ) {
      ...
      if (
        this.checkoutData.form.shipping_country == "" ||
        this.checkoutData.form.shipping_country == undefined
      ) {
      ...
      if (
        this.checkoutData.form.shipping_state == "" ||
        this.checkoutData.form.shipping_state == undefined
      ) {
