...
export class Settings implements OnInit {
  ...
  async presentToast(message) {
    this.translate
      .get("Please login to add items to the wishlist")
  ...
  calc(width) {
    ...
    if (width >= 1025) {
      ...
      this.dimensions.homeGridViewHeight =
        (this.dimensions.imageHeight / 100) *
        ((width - this.dimensions.productPadding * 10) / 5);
      this.dimensions.productsGridViewHeight =
        (this.dimensions.imageHeight / 100) *
        ((width - this.dimensions.productPadding * 10) / 5);
      this.dimensions.searchGridViewHeight =
        (this.dimensions.imageHeight / 100) *
        ((width - this.dimensions.productPadding * 10) / 5);
      this.dimensions.productSliderWidth = width * 0.2;
      this.dimensions.homeSliderWidth = width * 0.2;
      this.dimensions.homeSliderHeight =
        (this.dimensions.homeSliderWidth * this.dimensions.imageHeight) / 100;
      ...
      this.dimensions.homeGridViewHeight =
        (this.dimensions.imageHeight / 100) *
        ((width - this.dimensions.productPadding * 8) / 4);
      this.dimensions.productsGridViewHeight =
        (this.dimensions.imageHeight / 100) *
        ((width - this.dimensions.productPadding * 8) / 4);
      this.dimensions.searchGridViewHeight =
      ...
      this.dimensions.homeGridViewHeight =
        (this.dimensions.imageHeight / 100) *
        ((width - this.dimensions.productPadding * 6) / 3);
      this.dimensions.productsGridViewHeight =
        (this.dimensions.imageHeight / 100) *
        ((width - this.dimensions.productPadding * 6) / 3);
      this.dimensions.searchGridViewHeight =
      ...
      this.dimensions.homeGridViewHeight =
        ((this.dimensions.imageHeight / 100) *
          (width -
            this.dimensions.latestPerRow *
              this.dimensions.productPadding *
              2)) /
        this.dimensions.latestPerRow;
      this.dimensions.productsGridViewHeight =
        ((this.dimensions.imageHeight / 100) *
          (width -
            this.dimensions.productPadding *
              this.dimensions.latestPerRow *
              2)) /
        this.dimensions.productsPerRow;
      this.dimensions.searchGridViewHeight =
        ((this.dimensions.imageHeight / 100) *
          (width -
            this.dimensions.productPadding *
              this.dimensions.latestPerRow *
              2)) /
        this.dimensions.searchPerRow;
      this.dimensions.productSliderWidth = width * 0.4;
      this.dimensions.homeSliderWidth = width * 0.4;
      this.dimensions.homeSliderHeight =
        (this.dimensions.homeSliderWidth * this.dimensions.imageHeight) / 100;
      this.dimensions.homeGridViewWidth =
        width -
        (this.dimensions.latestPerRow * this.dimensions.productPadding * 2) /
          this.dimensions.latestPerRow;
    }
  }
}
