...
export class Config {
  ...
  lang: any = "en";
  constructor() {
    this.url = "https://opyix.com"; // Replace URL_PLACEHOLDER with you site url (http://example.com)
    this.consumerKey = "ck_4ceecc0baea172dbfd5e6d5407ca029ed948ec8c"; //Replace CONSUMER_KEY_PLACEHOLDER with you site consumer_key
    this.consumerSecret = "cs_1bc87074b37b9a9eff0ee6fece25f89bb2364bc4"; //Replace CONSUMER_KEY_PLACEHOLDER with you site consumer_secret
